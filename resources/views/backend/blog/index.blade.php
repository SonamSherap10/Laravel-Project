...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <article class="group btmspace-80">
      <div class="two_third first"><img class="borderedbox inspace-10" src="{{asset('frontend/images/demo/660x360.png')}}" alt=""></div>
      <div class="one_third">
    ...
    <ul class="nospace group overview">
      <li class="one_third">
        <article><a href="#"><img src="{{asset('frontend/images/demo/320x240.png')}}" alt=""></a>
